package com.poso2o.lechuan.tabview;
...
//                        mIconWidth <= 0 ? LinearLayout.LayoutParams.WRAP_CONTENT : (i == 1 ? (int) mIconWidth + 10 : (int) mIconWidth),
//                        mIconHeight <= 0 ? LinearLayout.LayoutParams.WRAP_CONTENT : (i == 1 ? (int) mIconHeight + 10 : (int) mIconHeight));
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
