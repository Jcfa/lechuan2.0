 ...
 */
public class SizeActivity extends BaseListActivity {
    ...
    public void initData() {
        ...
        adapter = new BaseListAdapter<GoodsSize>(this, true) {
            ...
            public void initItemView(BaseListAdapter.ListViewHolder holder, GoodsSize item, int position) {
                holder.list_item_text.setText(TextUtil.trimToEmpty(item.goods_size_name));
            }
        };
    ...
    private void loadData() {
        VdianSizeManager.getInstance().loadList(this, new IRequestCallBack<SizeBean>() {
            ...
            public void onFailed(int tag, String msg) {
                Toast.show(SizeActivity.this, msg);
                dismissLoading();
            }
        });
    }
    ...
    private void add(String name) {
        ...
        size.goods_size_name = name;
        size.sizeid = name;
        VdianSizeManager.getInstance().add(this, size, new IRequestCallBack<GoodsSize>() {
    ...
    private void delete(final GoodsSize size) {
        VdianSizeManager.getInstance().del(this, size.goods_size_id, new IRequestCallBack() {
