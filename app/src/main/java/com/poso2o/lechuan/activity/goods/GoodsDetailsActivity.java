...
public class GoodsDetailsActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        refreshRealView();
        goods_details_unit_group.setVisibility(GONE);
        goods_details_supplier_group.setVisibility(GONE);
        goods_details_sale_type.setVisibility(View.INVISIBLE);
    }
...
//        if (isVdian) {
//            goods_details_print.setVisibility(GONE);
//            goods_details_edit.setVisibility(GONE);
//            goods_details_sale_type.setVisibility(VISIBLE);
//            goods_details_share.setVisibility(VISIBLE);
...
//            }
//            // 上下架
//            goods_details_sale_type.setOnClickListener(new View.OnClickListener() {
//
//                @Override
...
//
//            // 分享
//            goods_details_share.setOnClickListener(new View.OnClickListener() {
//
//                @Override
//                public void onClick(View v) {
//                    shareWeb();
...
//        }
        ...
        goods_details_edit.setOnClickListener(new NoDoubleClickListener() {
            ...
            public void onNoDoubleClick(View v) {
                ...
                startActivityForResult(EditGoodsActivity.class, data, REQUEST_EDIT_GOODS);
            }
        });
...
//        }
        ...
        g.name = goods.name;
        g.price = goods.price;
        g.imgs = new ArrayList<>();
        GoodsDetailsImgsData img = new GoodsDetailsImgsData();
        img.pic = goods.image222;
        g.imgs.add(img);
        //颜色 尺码
        g.nums = new ArrayList<>();
        for (OldSpec spec : goods.nums) {
            GoodsDetailsNumsData detailsNum = new GoodsDetailsNumsData();
            detailsNum.barcode = spec.barcode;
            detailsNum.spec_name = spec.colorid + "/" + spec.sizeid;
            detailsNum.num = spec.num;
            ...
            if (resultCode == RESULT_OK) {
                switch (requestCode) {
                    case REQUEST_EDIT_GOODS:
                        ...
                        for (GoodsMovePicture movePicture : goods.goods_move_picture) {
                            GoodsDetailsImgsData imgsData = new GoodsDetailsImgsData();
                            imgsData.pic = movePicture.picture_url;
                            imgsData.pic464_464 = movePicture.picture_url;
                            imgsData.pic222_222 = movePicture.picture_url;
                            imgsData.pic66_66 = movePicture.picture_url;
                            goods.imgs.add(imgsData);
                        }
                        refreshRealView();
                        setResult(RESULT_OK);
                        break;
...
//                }
    ...
    private void shareWeb() {
        UMImage thumb = new UMImage(this, goods.image222);
        UMWeb web = new UMWeb(goods.image222);
        web.setThumb(thumb);
        web.setTitle(goods.name);
